...
<div class="page-container">
    <form class="form form-horizontal" action="<?php echo U('save');?>" method="post" onsubmit="return ac_from();" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <input type="text" class="input-text" name="point" id="point" value="<?php echo intval($voucher['point'])==0?0:$voucher['point']; ?>" >
        ...
        <li>
            ...
            <div>
                <?php if(is_array($voucher['pro_list'])): $i = 0; $__LIST__ = $voucher['pro_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><img src="/xcx_yamaxun/Data/<?php echo ($v); ?>" width="100px" height="100px" /><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </li>
        <?php } ?>
