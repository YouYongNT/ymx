...
<body>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 管理后台 <span class="c-gray en">&gt;</span> 管理首页 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);"
    ...
    <div class="page-container">
        <ul class="aaa_pts_show_6">
            ...
            <br>
            <li>小程序：
                <font class="r1" style="color:#090">
                    <?php echo $_SESSION["system"]['sysname'] ?>
                </font>
            </li>
