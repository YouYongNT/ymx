...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-vip">
            <dt><i class="Hui-iconfont">&#xe60d;</i> VIP卡管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
        ...
        <dl id="menu-tongji3">
            ...
            <dd>
                <ul>
                    <li>
                        <a data-title="添加地区" data-href="<?php echo U('Area/add');?>" href="<?php echo U('Area/add');?>" target="iframe">添加地区</a>
                    </li>

                    <li>
                        <a data-title="地区管理" data-href="<?php echo U('Area/index');?>" href="<?php echo U('Area/index');?>" target="iframe">地区管理</a>
                    </li>
