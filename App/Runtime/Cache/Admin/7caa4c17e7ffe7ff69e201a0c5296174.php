...
<body>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 分类管理 <span class="c-gray en">&gt;</span> 新增分类 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);"
        ...
        <form class="form form-horizontal" action="<?php echo U('save');?>" method="post" onsubmit="return ac_from();" enctype="multipart/form-data">
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-3">
                    <select class="inp_1 input-text" name="tid" id="tid">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-3">
                    ...
                    <img src="/xcx_yamaxun/Data/<?php echo $cate_info['bz_1']; ?>" width="200" height="200" />
                    <?php } ?>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-8">
                    <textarea class="inp_1 inp_8" name="concent" id="concent" />
                    <?php echo $cate_info['concent']; ?>
                    </textarea>
                </div>
            </div>
